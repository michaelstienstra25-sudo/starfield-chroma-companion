...
$singleFileSetupExe = Join-Path $root "StarfieldChromaCompanionSetup-v0.1.9-alpha.exe"
...
$zip = Join-Path $root "StarfieldChromaCompanion-v0.1.9-alpha-installer.zip"
