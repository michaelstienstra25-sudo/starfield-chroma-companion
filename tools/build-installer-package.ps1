...
$singleFileSetupExe = Join-Path $root "StarfieldChromaCompanionSetup-v0.1.3-alpha.exe"
...
$zip = Join-Path $root "StarfieldChromaCompanion-v0.1.3-alpha-installer.zip"
