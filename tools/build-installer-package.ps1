...
$singleFileSetupExe = Join-Path $root "StarfieldChromaCompanionSetup-v0.1.8-alpha.exe"
...
$zip = Join-Path $root "StarfieldChromaCompanion-v0.1.8-alpha-installer.zip"
